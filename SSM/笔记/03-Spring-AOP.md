...
<img src="assets/1761891815060-1.png" alt="img" style="zoom:67%;" />

至此AOP中的核心概念就已经介绍完了，总结下:

* 连接点(JoinPoint)：。程序执行过程中的任意位置，粒度为执行方法、抛出异常、设置变量等
  * 在SpringAOP中，理解为方法的执行-->可以被aop控制的方法
...
* `*`:==单个==独立的任意符号，可以独立出现，也可以作为==前缀或者后缀==的匹配符出现
...
![img](assets/1762238161812-1.png)

到此我们两种常见的切入点表达式我已经介绍完了。

- execution切入点表达式
  - 根据我们所指定的方法的描述信息来匹配切入点方法，这种方式也是**最为常用**的一种方式
...
==事务的传播行为加在子事务上的注解（@Transactional）==
